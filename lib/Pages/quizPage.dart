...
//things to think on:
//if dont take all words: not all words will be underlined, unless do the quiz several times
//if keep same list of words while going to other tabs, seed will also always provide same words in the quiz
class Words {
            ...
            child: Column(
              children: <Widget>[
                StreamProvider<List<Words>>.value(
                  value: db.streamWord(),
                  initialData: [Words(francais: '', portugais: '', index: 0), Words(francais: '', portugais: '', index: 0), Words(francais: '', portugais: '', index: 0), Words(francais: '', portugais: '', index: 0)],
                  child: Container(
...
class Entire extends StatelessWidget {
  // static final ran = getFinalValue();
...
// class EntireQuiz extends StatefulWidget {
//   @override
//   _EntireQuizState createState() => _EntireQuizState();
// }

// class _EntireQuizState extends State<EntireQuiz> {
//   @override
//   Widget build(BuildContext context) {
//     //return together front and back
// final _wordsback = Provider.of<List<Words>>(context);
//     print(_wordsback);
...
//     List<List<Words>> answersMapQuiz = answersQuiz();
...
class _QuizFrontState extends State<QuizFront> {
    // static final ran2 = getFinalValue();
  ...
  Widget build(BuildContext context) {
    ...
    quizAnswerChecker(
      ...
      if (widget.answersList[questionNumber][indexAnswer] ==
        ...
        debugPrint("Correct");
        // print(widget.answersList[questionNumber][indexAnswer]['francais']);
        // debugPrint("${widget.answersMapQuiz[indexAnswer][3].index}");
        finalScore++;
        setState(() {
          scorelist.add(1);
        });
